...
function Portfolio() {
    return (
      <div class="portfolio" className="portfolio">
          <h1>Portfolio</h1>
          <div class="project">
            ...
            <p class="description">This application is a fitness tracker in the browser allowing users to add exercises and workouts. Languages used include HTML, CSS, and JavaScript, and MongoDB and NoSQL were also used.</p>
          </div>
          <div class="project">
          ...
          <div class="project">
              ...
              <p class="description"> This assignment is an application allowing users to enter managers and employees.  Languages used include HTML, CSS, Node.js, and JavaScript.</p>
          </div>
          <div class="project">
          ...
          <div class="project">
            ...
            <p class="description">This group project allows users to search for movies, watch trailers, and discover new movies.</p>
          </div>
          <div class="project">
            <h3>Code Refactor</h3>
            ...
            <p class="description">This assignment was a code refactor.  The original page was not accessible for users with screen readers.  My code refactor adds semantic HTML and consolidates CSS so the code is cleaner.</p>
          </div>
      </div>  
    )
}
